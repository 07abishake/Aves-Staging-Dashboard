...
function Designation() {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            AssignUsersID: selectedUsers.map(user => user.value),
        };
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            ...
            // Refresh the designations list and close edit canvas
            fetchDesignations();
                    ...
                    {selectedDesignation && (
                        <div className="offcanvas-body p-2">
                            ...
                            <ul className="list-group">
                                {selectedDesignation.AssignUsers && selectedDesignation.AssignUsers.length > 0 ? (
