...
function LocationManager() {
    ...
    // Open edit form for specific level
    const openEditForm = (location, level, data = {}) => {
        setSelectedLocation(location);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            // Construct URL and payload based on editing level
            switch (editingLevel) {
                case 'primary':
                    url = `https://codeaves.avessecurity.com/api/Location/updatePrimary/${selectedLocation._id}`;
                    payload = { PrimaryLocation: editData.PrimaryLocation };
                    break;
                case 'subLocation':
                    url = `https://codeaves.avessecurity.com/api/Location/updateSubLocation/${selectedLocation._id}/${editData._id}`;
                    payload = { PrimarySubLocation: editData.PrimarySubLocation };
                    break;
                case 'secondary':
                    url = `https://codeaves.avessecurity.com/api/Location/updateSecondary/${selectedLocation._id}/${editData.subLocationId}/${editData._id}`;
                    payload = { SecondaryLocation: editData.SecondaryLocation };
                    break;
                case 'secondarySub':
                    url = `https://codeaves.avessecurity.com/api/Location/updateSecondarySub/${selectedLocation._id}/${editData.subLocationId}/${editData.secondaryLocationId}/${editData._id}`;
                    payload = { SecondarySubLocation: editData.SecondarySubLocation };
                    break;
                case 'third':
                    url = `https://codeaves.avessecurity.com/api/Location/updateThird/${selectedLocation._id}/${editData.subLocationId}/${editData.secondaryLocationId}/${editData.secondarySubLocationId}/${editData._id}`;
                    payload = { 
                        ThirdLocation: editData.ThirdLocation,
                        ThirdSubLocation: editData.ThirdSubLocation 
                    };
                    break;
                default:
                    throw new Error('Invalid editing level');
            }
            ...
            alert(`${editingLevel} updated successfully`);
            setShowEditCanvas(false);
            setEditingLevel(null);
            setEditData({});
            fetchLocations();
            ...
            alert(`Error updating ${editingLevel}: ${err.response?.data?.message || err.message}`);
        } finally {
            setIsLoading(false);
        }
    };
                                ...
                                subLoc.SecondaryLocation.forEach(sec => {
                                    if (sec.SecondaryLocation?.toLowerCase() === parentLocations.secondary?.toLowerCase()) {
                                        if (Array.isArray(sec.SecondarySubLocation)) {
                                            sec.SecondarySubLocation.forEach(subSec => {
                                                if (Array.isArray(subSec.ThirdLocation)) {
                                                    subSec.ThirdLocation.forEach(third => {
                                                        if (third.ThirdLocation?.toLowerCase().includes(value.toLowerCase())) {
                                                            allSuggestions.add(third.ThirdLocation);
                                                        }
                                                    });
    ...
    // Render edit form based on level
    const renderEditForm = () => {
        if (!editingLevel) return null;

        const getTitle = () => {
            switch (editingLevel) {
                case 'primary': return 'Edit Primary Location';
                case 'subLocation': return 'Edit Sub Location';
                case 'secondary': return 'Edit Secondary Location';
                case 'secondarySub': return 'Edit Secondary Sub Location';
                case 'third': return 'Edit Third Location';
                    ...
                    return (
                        <div className="mb-3">
                            ...
                            <input
                                type="text"
                                className="form-control"
                                value={editData.PrimaryLocation || ''}
                                onChange={(e) => setEditData({...editData, PrimaryLocation: e.target.value})}
                                required
                            />
                        </div>
                    );
                    ...
                    return (
                        <div className="mb-3">
                            ...
                            <input
                                type="text"
                                className="form-control"
                                value={editData.PrimarySubLocation || ''}
                                onChange={(e) => setEditData({...editData, PrimarySubLocation: e.target.value})}
                                required
                            />
                        </div>
                    );
                    ...
                    return (
                        <div className="mb-3">
                            ...
                            <input
                                type="text"
                                className="form-control"
                                value={editData.SecondaryLocation || ''}
                                onChange={(e) => setEditData({...editData, SecondaryLocation: e.target.value})}
                                required
                            />
                        </div>
                    );
                    ...
                    return (
                        <div className="mb-3">
                            ...
                            <input
                                type="text"
                                className="form-control"
                                value={editData.SecondarySubLocation || ''}
                                onChange={(e) => setEditData({...editData, SecondarySubLocation: e.target.value})}
                                required
                            />
                        </div>
                    );
                        ...
                        <>
                            <div className="mb-3">
                                ...
                                <input
                                    type="text"
                                    className="form-control"
                                    value={editData.ThirdLocation || ''}
                                    onChange={(e) => setEditData({...editData, ThirdLocation: e.target.value})}
                                    required
                                />
                            </div>
                            <div className="mb-3">
                                ...
                                <input
                                    type="text"
                                    className="form-control"
                                    value={editData.ThirdSubLocation || ''}
                                    onChange={(e) => setEditData({...editData, ThirdSubLocation: e.target.value})}
                                />
                            </div>
                        </>
                    );
        ...
        return (
            <div className={`offcanvas offcanvas-end ${showEditCanvas ? 'show' : ''}`} 
                 style={{ visibility: showEditCanvas ? 'visible' : 'hidden', width: '500px' }}>
                <div className="offcanvas-header text-black">
                    <h5 className="offcanvas-title">{getTitle()}</h5>
                    <button type="button" className="btn-close" onClick={closeEditCanvas}></button>
                </div>
                <div className="offcanvas-body">
        ...
        <div className="container mt-4">
                        ...
                        <tbody>
                            {Array.isArray(locations) && locations.map(loc => (
                                <tr key={loc._id}>
                                    <td>
                                        <div className="d-flex align-items-center">
                                            <span>{loc.PrimaryLocation}</span>
                                            <button
                                                className="btn btn-sm btn-outline-warning ms-2"
                                                onClick={() => openEditForm(loc, 'primary', {
                                                    PrimaryLocation: loc.PrimaryLocation,
                                                    _id: loc._id
                                                })}
                                                title="Edit Primary Location"
                                            >
                                    ...
                                    <td>
                                        {Array.isArray(loc.SubLocation) && loc.SubLocation.map((subLoc, i) => (
                                            <div key={i} className="d-flex align-items-center mb-1">
                                                <span>{subLoc.PrimarySubLocation}</span>
                                                <button
                                                    className="btn btn-sm btn-outline-warning ms-2"
                                                    onClick={() => openEditForm(loc, 'subLocation', {
                                                        PrimarySubLocation: subLoc.PrimarySubLocation,
                                                        _id: subLoc._id
                                                    })}
            ...
            <div className={`offcanvas offcanvas-end ${showViewCanvas ? 'show' : ''}`} 
                ...
                <div className="offcanvas-header bg-light">
                    ...
                    <button type="button" className="btn-close" onClick={closeViewCanvas}></button>
                </div>
                <div className="offcanvas-body p-0">
                    {selectedLocation && (
                        <div className="location-details">
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <button
                                            ...
                                            onClick={() => openEditForm(selectedLocation, 'primary', {
                                                PrimaryLocation: selectedLocation.PrimaryLocation,
                                        ...
                                        <div className="mb-4">
                                            <div className="d-flex align-items-center justify-content-between mb-2">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => openEditForm(selectedLocation, 'subLocation', {
                                                        PrimarySubLocation: subLoc.PrimarySubLocation,
                                                        _id: subLoc._id
                                                    })}
                                                >
                                                ...
                                                <div key={secIdx} className="card mb-3 shadow-sm">
                                                    <div className="card-header bg-white py-3">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <button
                                                                className="btn btn-sm btn-outline-warning"
                                                                onClick={() => openEditForm(selectedLocation, 'secondary', {
                                                                    SecondaryLocation: sec.SecondaryLocation,
                                                                    _id: sec._id,
                                                                    subLocationId: subLoc._id
                                                                })}
                                                            >
                                                                <i className="bi bi-pencil"></i> Edit
                                                            </button>
                                                                    ...
                                                                    {sec.SecondarySubLocation.map((subSec, subSecIdx) => (
                                                                        <li key={subSecIdx} className="list-group-item px-0 py-2">
                                                                            <div className="d-flex align-items-center justify-content-between">
                                                                                ...
                                                                                <button
                                                                                    className="btn btn-sm btn-outline-warning"
                                                                                    onClick={() => openEditForm(selectedLocation, 'secondarySub', {
                                                                                        SecondarySubLocation: subSec.SecondarySubLocation,
                                                                                        _id: subSec._id,
                                                                                        subLocationId: subLoc._id,
                                                                                        secondaryLocationId: sec._id
                                                                                    })}
                                                                                >
                                                                                    <i className="bi bi-pencil"></i> Edit
                                                                                </button>
                                                                                        ...
                                                                                        {subSec.ThirdLocation.map((third, thirdIdx) => (
                                                                                            <li key={thirdIdx} className="list-group-item px-0 py-2 bg-light rounded mb-1">
                                                                                                <div className="d-flex justify-content-between align-items-start">
                                                                                                    ...
                                                                                                    <button
                                                                                                        className="btn btn-sm btn-outline-warning"
                                                                                                        onClick={() => openEditForm(selectedLocation, 'third', {
                                                                                                            ThirdLocation: third.ThirdLocation,
                                                                                                            ThirdSubLocation: third.ThirdSubLocation,
                                                                                                            _id: third._id,
                                                                                                            subLocationId: subLoc._id,
                                                                                                            secondaryLocationId: sec._id,
                                                                                                            secondarySubLocationId: subSec._id
                                                                                                        })}
                                                                                                    >
                                                                                                        <i className="bi bi-pencil"></i> Edit
                                                                                                    </button>
